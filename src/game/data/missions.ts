...
export const missionDefinitions: Record<MissionId, MissionDefinition> = {
  infiniteSurvivalV8: {
    ...
    subtitle: "Score et phases",
    description:
      "Survis à des vagues de plus en plus dangereuses. Il n'y a pas de victoire finale.",
    briefing: [
      "Le mode infini est séparé de la campagne et de la carte du corps.",
      "Les phases montent progressivement jusqu'à un niveau extrême.",
      "Les mutateurs changent les règles : lis-les avant de surproduire.",
    ],
    objectives: [
      ...
      { id: "inflam90", label: "Éviter une crise inflammatoire totale", kind: "inflammationBelow", value: 90 },
    ],
    victoryConditions: [],
  ...
  woundBacteriaV1: {
    id: "woundBacteriaV1",
    title: "Mission 1 · Plaie cutanée",
    displayName: "Plaie cutanée",
    subtitle: "Macrophages et bactéries simples",
    description: "Apprends à sélectionner, déplacer et utiliser les macrophages.",
    briefing: [
      "Une petite plaie laisse entrer des bactéries rapides.",
      "Les macrophages sont l'infanterie lente mais robuste de l'immunité innée.",
      "Sélectionne un macrophage avec clic gauche, puis clique sur la carte pour le déplacer.",
    ],
    objectives: [
      { id: "clear", label: "Éliminer toutes les bactéries", kind: "clearThreats", required: true },
    ...
    defeatConditions: easyFailure,
    startingResources: { atp: 115, cytokines: 0, antigens: 0 },
    startingUnits: [{ unitTypeId: "macrophage", count: 3 }],
    ...
    waves: [
      { startsAtMs: 2200, pathogenTypeId: "cocciRapid", count: 3, spawnIntervalMs: 1100 },
      { startsAtMs: 15000, pathogenTypeId: "cocciRapid", count: 4, spawnIntervalMs: 950 },
    ],
    tutorialHints: [
      { text: "Clic gauche sur une unité pour la sélectionner, clic gauche sur le sol pour donner un ordre." },
    ],
  ...
  inflammatoryReactionV2: {
    ...
    title: "Mission 2 · Réaction inflammatoire",
    displayName: "Réaction inflammatoire",
    subtitle: "Cytokines et neutrophiles",
    description: "Utilise les neutrophiles sans laisser l'inflammation déraper.",
    briefing: [
      "Les cytokines recrutent vite des renforts.",
      "Les neutrophiles frappent fort, mais ils rendent la zone plus inflammatoire.",
      "Ne les recrute pas sans mesure : une inflammation excessive abîme le tissu.",
    ],
    objectives: [
      { id: "clear", label: "Survivre aux vagues bactériennes", kind: "clearThreats", required: true },
    ...
    victoryConditions: [{ kind: "allWavesCleared" }, { kind: "requiredObjectivesComplete" }],
    defeatConditions: easyFailure,
    startingResources: { atp: 135, cytokines: 42, antigens: 0 },
    startingUnits: [
      { unitTypeId: "macrophage", count: 3 },
      { unitTypeId: "neutrophil", count: 1 },
    ],
    ...
    map: skinSmallWoundMap,
    waves: [
      { startsAtMs: 2200, pathogenTypeId: "cocciRapid", count: 4, spawnIntervalMs: 850 },
      { startsAtMs: 17000, pathogenTypeId: "proliferatingBacillus", count: 2, spawnIntervalMs: 1400 },
      { startsAtMs: 35000, pathogenTypeId: "cocciRapid", count: 5, spawnIntervalMs: 750 },
    ],
  ...
  persistentInfectionV3: {
    ...
    subtitle: "Colonies, résistance et biofilm léger",
    description: "Cible les colonies et gère une pression plus lente mais plus solide.",
    briefing: [
      "Certaines bactéries résistent mieux ou forment une protection de groupe.",
      "Les colonies à biofilm ne sont pas rapides, mais elles rendent les combats plus longs.",
    ...
    victoryConditions: [{ kind: "allWavesCleared" }, { kind: "requiredObjectivesComplete" }],
    defeatConditions: easyFailure,
    startingResources: { atp: 155, cytokines: 50, antigens: 0 },
    startingUnits: [
      { unitTypeId: "macrophage", count: 4 },
      { unitTypeId: "neutrophil", count: 1 },
    ],
    unlockedUnits: ["macrophage", "neutrophil"],
    unlockedAbilities: [],
    ...
    waves: [
      { startsAtMs: 3000, pathogenTypeId: "proliferatingBacillus", count: 2, spawnIntervalMs: 1600 },
      { startsAtMs: 24000, pathogenTypeId: "resistantBacterium", count: 2, spawnIntervalMs: 2400 },
      { startsAtMs: 45000, pathogenTypeId: "biofilmColony", count: 1, spawnIntervalMs: 1200 },
      { startsAtMs: 66000, pathogenTypeId: "cocciRapid", count: 5, spawnIntervalMs: 900 },
    ],
  ...
  antigenAnalysisV4: {
    ...
    title: "Mission 4 · Analyse antigénique",
    displayName: "Analyse antigénique",
    subtitle: "Dendritiques, débris et ganglion",
    description: "Collecte les débris pathogènes pour générer des antigènes.",
    briefing: [
      "Les cellules dendritiques ne sont pas offensives.",
      "Elles collectent les débris, puis les apportent au ganglion pour produire des antigènes.",
      "Ces antigènes serviront à débloquer les réponses adaptatives.",
    ],
    objectives: [
      { id: "clear", label: "Survivre aux vagues", kind: "clearThreats", required: true },
      { id: "antigens12", label: "Collecter 12 antigènes", kind: "antigensAtLeast", value: 12, required: true },
      { id: "health35", label: "Garder le tissu au-dessus de 35%", kind: "tissueHealthAtLeast", value: 35 },
    ],
    victoryConditions: [{ kind: "allWavesCleared" }, { kind: "requiredObjectivesComplete" }],
    defeatConditions: easyFailure,
    startingResources: { atp: 155, cytokines: 52, antigens: 0 },
    startingUnits: [
      { unitTypeId: "macrophage", count: 3 },
      { unitTypeId: "neutrophil", count: 1 },
      { unitTypeId: "dendriticCell", count: 1 },
    ...
    map: lymphSignalMap,
    waves: [
      { startsAtMs: 2500, pathogenTypeId: "proliferatingBacillus", count: 3, spawnIntervalMs: 1400 },
      { startsAtMs: 23000, pathogenTypeId: "resistantBacterium", count: 2, spawnIntervalMs: 2200 },
      { startsAtMs: 46000, pathogenTypeId: "cocciRapid", count: 5, spawnIntervalMs: 800 },
    ],
    tutorialHints: [{ text: "Les dendritiques peuvent porter 3 débris avant de retourner au ganglion." }],
    nextMissionId: "adaptiveResponseV5",
    scoreReward: 160,
  },
  adaptiveResponseV5: {
    id: "adaptiveResponseV5",
    title: "Mission 5 · Réponse adaptative",
    displayName: "Réponse adaptative",
    subtitle: "Analyse bactérienne et anticorps",
    description: "Débloque la recherche bactérienne, les plasmocytes et la neutralisation massive.",
    briefing: [
      "La réponse adaptative arrive plus tard, mais elle frappe plus spécifiquement.",
      "Collecte assez d'antigènes, lance l'analyse bactérienne, puis produis des plasmocytes.",
      "La neutralisation massive est puissante, mais coûteuse.",
    ],
    objectives: [
      { id: "analysis", label: "Compléter l'analyse bactérienne", kind: "researchComplete", researchId: "bacterialAnalysis", required: true },
      { id: "clear", label: "Éliminer l'infection", kind: "clearThreats", required: true },
      { id: "health35", label: "Garder le tissu au-dessus de 35%", kind: "tissueHealthAtLeast", value: 35 },
    ],
    victoryConditions: [{ kind: "allWavesCleared" }, { kind: "requiredObjectivesComplete" }],
    defeatConditions: easyFailure,
    startingResources: { atp: 168, cytokines: 70, antigens: 12 },
    startingUnits: [
      { unitTypeId: "macrophage", count: 4 },
      { unitTypeId: "neutrophil", count: 2 },
      { unitTypeId: "dendriticCell", count: 1 },
    ],
    ...
    map: lymphSignalMap,
    waves: [
      { startsAtMs: 3500, pathogenTypeId: "proliferatingBacillus", count: 2, spawnIntervalMs: 1600 },
      { startsAtMs: 26000, pathogenTypeId: "resistantBacterium", count: 1, spawnIntervalMs: 2400 },
      { startsAtMs: 50000, pathogenTypeId: "biofilmColony", count: 1, spawnIntervalMs: 4000 },
      { startsAtMs: 76000, pathogenTypeId: "toxicBacterium", count: 1, spawnIntervalMs: 2000 },
    ],
  ...
  viralInfectionV6: {
    ...
    subtitle: "Virus, cellules infectées et interférons",
    description: "Les virus infectent les cellules civiles au lieu d'attaquer directement le tissu.",
    briefing: [
      "Un virus libre cherche une cellule saine et la transforme en cellule infectée.",
      "Les cellules infectées produisent ensuite de nouveaux virus.",
      "Les interférons ralentissent la propagation, mais ne nettoient pas tout seuls.",
    ],
    objectives: [
      { id: "waves", label: "Tenir 2 vagues virales", kind: "allWavesSpawned", value: 2, required: true },
      { id: "virusKills3", label: "Éliminer 3 virus libres", kind: "pathogenKillsAtLeast", pathogenTypeId: "respiratoryVirus", value: 3, required: true },
      { id: "interferons", label: "Utiliser les interférons", kind: "abilityUsed", abilityId: "interferons" },
    ],
    victoryConditions: [{ kind: "requiredObjectivesComplete" }],
    defeatConditions: easyFailure,
    startingResources: { atp: 168, cytokines: 90, antigens: 0 },
    startingUnits: [
      { unitTypeId: "macrophage", count: 4 },
      { unitTypeId: "dendriticCell", count: 1 },
    ],
    ...
    vaccinationOptions: [
      {
        ...
        antigenBonus: 8,
        cytokineBonus: 8,
        description: "Préparation simple contre le virus respiratoire : démarre avec des antigènes et cytokines bonus.",
      },
    ],
    ...
    waves: [
      { startsAtMs: 3500, pathogenTypeId: "respiratoryVirus", count: 2, spawnIntervalMs: 2200 },
      { startsAtMs: 30000, pathogenTypeId: "respiratoryVirus", count: 2, spawnIntervalMs: 2100 },
      { startsAtMs: 60000, pathogenTypeId: "respiratoryVirus", count: 3, spawnIntervalMs: 1800 },
    ],
    tutorialHints: [{ text: "Les interférons protègent temporairement les cellules dans la zone du tissu." }],
  ...
  viralCleanupV7: {
    ...
    description: "Détruis les cellules infectées avec NK puis débloque la réponse T cytotoxique.",
    briefing: [
      "Certaines cellules sont déjà infectées au début.",
      "Les cellules NK répondent vite, les T cytotoxiques demandent une analyse virale.",
      "Détruire une cellule infectée coûte du tissu, mais sauve l'ensemble.",
    ],
    objectives: [
      { id: "viralAnalysis", label: "Compléter l'analyse virale", kind: "researchComplete", researchId: "viralAnalysis", required: true },
      { id: "infectedEliminated5", label: "Éliminer 5 cellules infectées", kind: "infectedCellsEliminatedAtLeast", value: 5, required: true },
    ],
    victoryConditions: [{ kind: "requiredObjectivesComplete" }],
    defeatConditions: easyFailure,
    startingResources: { atp: 168, cytokines: 90, antigens: 18 },
    startingUnits: [
      { unitTypeId: "macrophage", count: 4 },
      { unitTypeId: "dendriticCell", count: 1 },
      { unitTypeId: "nkCell", count: 3 },
    ],
    ...
    vaccinationOptions: [
      {
        ...
        antigenBonus: 10,
        cytokineBonus: 6,
        description: "Prépare la réponse T contre une menace virale connue.",
      },
    ],
    memoryHintProfiles: ["viral"],
    allowedPathogens: ["respiratoryVirus"],
    ...
    map: lungBranchingMap,
    waves: [
      { startsAtMs: 10000, pathogenTypeId: "respiratoryVirus", count: 3, spawnIntervalMs: 3000 },
    ],
  ...
  mixedInfectionV8: {
    ...
    description: "Combine bactéries, biofilm, virus, inflammation et réponse adaptative.",
    briefing: [
      "Tout arrive en même temps : bactéries, virus libres et cellules infectées.",
      "Priorise les menaces : biofilm, propagation virale, inflammation, tissu.",
      "Tu as accès à tout l'arsenal immunitaire disponible.",
    ],
    objectives: [
      { id: "clear", label: "Survivre à l'infection mixte", kind: "clearThreats", required: true },
      { id: "health40", label: "Garder le tissu au-dessus de 40%", kind: "tissueHealthAtLeast", value: 40 },
      { id: "inflam85", label: "Éviter une inflammation finale au-dessus de 85", kind: "inflammationBelow", value: 85 },
      { id: "infected12", label: "Limiter les cellules infectées à 12", kind: "infectedCellsAtMost", value: 12 },
    ],
    victoryConditions: [{ kind: "allWavesCleared" }, { kind: "requiredObjectivesComplete" }],
    defeatConditions: easyFailure,
    startingResources: { atp: 168, cytokines: 105, antigens: 18 },
    startingUnits: [
      { unitTypeId: "macrophage", count: 4 },
      { unitTypeId: "neutrophil", count: 2 },
      { unitTypeId: "dendriticCell", count: 1 },
      { unitTypeId: "nkCell", count: 2 },
    ],
    ...
    vaccinationOptions: [
      {
        ...
        displayName: "Préparation antibactérienne",
        targetProfile: "bacterial",
        atpCost: 20,
        antigenBonus: 8,
        cytokineBonus: 4,
        description: "Préparation adaptée aux colonies bactériennes attendues.",
      },
      {
        id: "mixed-viral-prime",
        displayName: "Préparation antivirale",
        targetProfile: "viral",
        atpCost: 20,
        antigenBonus: 8,
        cytokineBonus: 6,
        description: "Préparation adaptée aux virus libres et cellules infectées.",
      },
    ],
    memoryHintProfiles: ["bacterial", "viral"],
    ...
    map: infiniteLargeTissueMap,
    waves: [
      { startsAtMs: 8000, pathogenTypeId: "cocciRapid", count: 2, spawnIntervalMs: 1900 },
      { startsAtMs: 30000, pathogenTypeId: "respiratoryVirus", count: 2, spawnIntervalMs: 2500 },
      { startsAtMs: 54000, pathogenTypeId: "proliferatingBacillus", count: 2, spawnIntervalMs: 2000 },
      { startsAtMs: 80000, pathogenTypeId: "biofilmColony", count: 1, spawnIntervalMs: 4000 },
      { startsAtMs: 108000, pathogenTypeId: "respiratoryVirus", count: 2, spawnIntervalMs: 2500 },
      { startsAtMs: 134000, pathogenTypeId: "resistantBacterium", count: 1, spawnIntervalMs: 2500 },
      { startsAtMs: 158000, pathogenTypeId: "toxicBacterium", count: 1, spawnIntervalMs: 2400 },
    ],
    scoreReward: 260,
  },
  skinBacterialSkirmish: {
  ...
  skinFungalOutbreak: {
    ...
    tutorialHints: [{ text: "Une colonie fongique est lente, mais elle crée des spores si elle survit." }],
    scoreReward: 180,
  },
  lungViralSpread: {
    id: "lungViralSpread",
  ...
  lungCancerSuspectCells: {
    ...
    briefing: [
      ...
      "NK et T cytotoxiques sont les réponses principales face à cette menace.",
    ],
    objectives: [
    ...
    tutorialHints: [{ text: "Les cellules anormales sont plus sensibles aux NK et T cytotoxiques." }],
    scoreReward: 205,
  },
  intestineBacillusSwarm: {
  ...
  intestineParasiteBoss: {
    ...
    tutorialHints: [{ text: "Le parasite est une menace majeure. Garde tes unités groupées et surveille l'inflammation." }],
    scoreReward: 230,
  },
  bloodMixedAlert: {
    id: "bloodMixedAlert",
  ...
  opportunisticMixedFlare: {
    ...
    subtitle: "Menaces opportunistes",
    ...
    tutorialHints: [{ text: "Les opportunistes punissent les zones affaiblies. Nettoie vite les petits groupes." }],
    scoreReward: 210,
  },
  lymphNodeSignalResponse: {
  ...
  boneMarrowReinforcementPressure: {
    ...
    briefing: [
      ...
      "Elle donne surtout un enjeu stratégique aux ressources globales.",
  ...
  liverAbnormalGrowth: {
    ...
    briefing: [
      ...
      "Cette mission consolide les acquis sans ajouter de mécanique lourde.",
    ],
    objectives: [
    ...
    tutorialHints: [{ text: "Les cellules anormales ne sont pas des microbes, mais une menace interne simplifiée." }],
    scoreReward: 225,
  },
};
